...
<form class="layui-form" id="noticeFrm">
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="noticeTitle" id="noticeTitle" placeholder="请输入标题..." lay-verify="required"
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <textarea name="noticeContent" placeholder="请输入公告内容" id="noticeContent" autocomplete="off" class="layui-textarea"></textarea>
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">备注</label>
        <div class="layui-input-block">
            <textarea type="text" name="remark" id="remark" placeholder="请输入备注信息..." autocomplete="off"
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="radio" name="noticeType" autocomplete="off" title="公告" value="2" checked>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="checkbox" name="status" checked="" autocomplete="off" lay-skin="switch" title="否"
                   lay-text="启用|禁用"
                   lay-filter="status">
        </div>
    </div>
