...
<body>
<!--图标的使用-->
<div class="layui-card" style="padding: 15px;text-align: center;">
    <div class="layui-card-body">
        ...
        <ul class="site-doc-icon">
            ...
            <li>
                <i class="layui-icon layui-icon-verdoc-icon-code"></i>
                <div class="doc-icon-name">验证码</div>
                <div class="doc-icon-code">&amp;#xe679;</div>
                <div class="doc-icon-fontclass">layui-icon-verdoc-icon-code</div>
            </li>
            <li>
            ...
            <li>
                <i class="layui-icon layui-icon-fonts-doc-icon-code"></i>
                <div class="doc-icon-name">代码</div>
                <div class="doc-icon-code">&amp;#xe64e;</div>
                <div class="doc-icon-fontclass">layui-icon-fonts-doc-icon-code</div>
            </li>
            <li>
            ...
            <li>
                <i class="layui-icon layui-icon-doc-icon-code-circle"></i>
                <div class="doc-icon-name">代码-圆圈</div>
                <div class="doc-icon-code">&amp;#xe635;</div>
                <div class="doc-icon-fontclass">layui-icon-doc-icon-code-circle</div>
            </li>
            <li>
...
<!--引入layui.js-->
<script type="text/javascript" src="${ctx}/resources/layui/layui.js" charset="UTF-8"></script>
<script type="text/javascript">
    layui.use(['layer', 'form', 'element', 'table', 'jquery'], function () {
        ...
        $(".site-doc-icon li").on("click", function () {
            var selectIcon = $(this).find("div.doc-icon-code").text();
            //赋值
            $('#copyText').text(selectIcon);
            //选中元素
            $('#copyText').select();
            //拷贝元素中的值
